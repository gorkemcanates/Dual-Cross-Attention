...
from model.utils.main_blocks import DropPath, trunc_normal_
...
class SwinUnet(nn.Module):
    ...
    def load_from(self):
        ...
        if pretrained_path is not None:
            ...
            # torch.save(self.swin_unet.state_dict(), 'model/checkpoints/swin_unet.pth', _use_new_zipfile_serialization=False)
